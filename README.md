...
- [jenetics](http://jenetics.io/) -based Genetic Algorithm(GA) solver - [GASolver.java](src/main/java/com/github/illya13/snakebattle/solver/GASolver.java). It takes `4h` to evaluate `50 genotypes` by `2 GA solvers` locally, period: `100ms`. Each `evaluation` is an average over `20` game rounds.  
