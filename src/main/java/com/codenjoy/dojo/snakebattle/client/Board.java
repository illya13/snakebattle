...
public class Board extends AbstractBoard<Elements> {
    ...
    public static final Elements[] SAFE_ELEMENTS = join(EMPTY_ELEMENTS, STONE_ELEMENTS, ME_HEAD_ELEMENTS, ME_BODY_ELEMENTS, ME_TAIL_ELEMENTS, ENEMY_TAIL_ELEMENTS);
    ...
    public static final Elements[] BARRIER_NO_WAY = join(BARRIER_ELEMENTS);
