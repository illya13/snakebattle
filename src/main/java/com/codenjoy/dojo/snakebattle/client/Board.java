...
public class Board extends AbstractBoard<Elements> {
    ...
    public static final Elements[] BARRIER_NORMAL = join(BARRIER_ELEMENTS, ME_BODY_ELEMENTS, ENEMY_ELEMENTS);
    ...
    public static final Elements[] BARRIER_NORMAL_STONE = join(BARRIER_ELEMENTS, STONE_ELEMENTS, ME_BODY_ELEMENTS, ENEMY_ELEMENTS);
